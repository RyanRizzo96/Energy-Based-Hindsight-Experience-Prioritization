...
def main():
    ...
    parser.add_argument('--dirs', help='List of log directories', nargs='*', default=['/Users/ryanr/B.Eng/MCAST_Degree_4/Thesis/code/gym/RL_baselines/.log/two_seeds/saved/run_1/Fetch_Pick_And_Place/FPAP_200k-4'])
