...
for curr_path in paths:
    if not os.path.isdir(curr_path):
        continue
    results = load_results(os.path.join('/Users/ryanr/B.Eng/MCAST_Degree_4/Thesis/code/gym/RL_baselines/.log/two_seeds/saved/run_1/Fetch_Pick_And_Place/FPAP_200k-4', 'progress.csv'))
    if not results:
