...
python3 -m baselines.run --alg=her --env=FetchPush-v1 --num_timesteps=100000 --save_path=/home/ubuntu/Energy-Based-Prioritization/EBP_policy/FetchPush/Method2/temp0.5/trial-$seed --seed=$seed; done
