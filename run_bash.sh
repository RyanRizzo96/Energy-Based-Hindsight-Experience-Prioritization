...
for seed in $(seq 0 0); do OPENAI_LOGDIR=/home/ubuntu/RL_baselines/.log/two_seeds/run_1/HandManipulateBlockFull-$seed mpirun -np 16 python3 -m baselines.run --alg=her --env=HandManipulateBlockFull-v0  --num_timesteps=500000 --seed=$seed --layers=3 --save_path=/home/ubuntu/RL_baselines/.log/two_seeds/Policies/HandManipulateBlockFull-$seed; done
...
# python3 -m baselines.run --alg=her --env=HandManipulateEggFull-v0 --num_timesteps=500
