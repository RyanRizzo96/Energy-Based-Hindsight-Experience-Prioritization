...
OPENAI_LOGDIR=/home/ubuntu/Energy-Based-Prioritization/EBP_mod/FetchPickAndPlace/Method3/temp0.65/trial-$seed mpirun -np 16 \
python3 -m baselines.run --alg=her --env=FetchPickAndPlace-v1 --num_timesteps=100000 \
--save_path=/home/ubuntu/Energy-Based-Prioritization/EBP_policy/FetchPickAndPlace/Method3/temp0.65/trial-$seed --seed=$seed; done
