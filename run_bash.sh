...
for seed in $(seq 0 5); do OPENAI_LOGDIR=.log/tensorboard_test/actor_critic_loss/run4 python3 -m baselines.run --alg=her --env=FetchPush-v1 --num_timesteps=10000 --seed=$seed --layers=6; done
