...
for seed in $(seq 0 4); do OPENAI_LOGDIR=/home/ubuntu/RL_baselines/.log/4_seeds/log/FetchPush-$seed mpirun -np 16 python3 -m baselines.run --alg=her --env=FetchPush-v1  --num_timesteps=400000 --seed=$seed --layers=3 --save_path=/home/ubuntu/RL_baselines/.log/4_seeds/plocicies/FetchPush-$seed; done
...
# python3 -m baselines.run --alg=her --env=HandManipulateEggFull-v0 --num_timesteps=500000
