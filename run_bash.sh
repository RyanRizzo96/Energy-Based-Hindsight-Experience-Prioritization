...
OPENAI_LOGDIR=/home/ubuntu/Energy-Based-Prioritization/EBP_mod/FetchPush/EBP/temp1/trial-$seed mpirun -np 16 \
python3 -m baselines.run --alg=her --env=FetchPush-v1 --num_timesteps=50000 --save_path=/home/ubuntu/Energy-Based-Prioritization/EBP_policy/FetchPush/EBP/temp1/trial-$seed --seed=$seed; done
