...
for seed in $(seq 0 0); do OPENAI_LOGDIR=/home/ubuntu/Energy-Based-Prioritization/EBP_mod/FPAP_100k/run1-$seed mpirun -np 16 python3 -m baselines.run --alg=her --env=FetchPickAndPlace-v1 --num_timesteps=200000 --seed=$seed; done
