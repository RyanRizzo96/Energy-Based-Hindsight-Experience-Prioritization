...
python3 -m baselines.run --alg=her --env=FetchReach-v1 --num_timesteps=2000 --save_path=~./models/thesis_demo_model/run4

# python3 -m baselines.run --alg=her --env=FetchReach-v1 --num_timesteps=0 --load_path=/models/thesis_demo/run4 --play
