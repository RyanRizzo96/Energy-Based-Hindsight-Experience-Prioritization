...
for seed in $(seq 0 1); do OPENAI_LOGDIR=/home/ubuntu/Energy-Based-Prioritization/EBP_mod/FPUSH_RR_temp0.2/trial1-$seed mpirun -np 16 python3 -m baselines.run --alg=her --env=FetchPush-v1 --num_timesteps=100000 --seed=$seed; done
# python3 -m baselines.run --alg=her --env=FetchReach-v1 --num_timesteps=500 --num_envs=4
