...
for seed in $(seq 0 0); do OPENAI_LOGDIR=/home/ubuntu/Energy-Based-Prioritization/EBP_mod/FPUSH_RR/run1-$seed mpirun -np 16 python3 -m baselines.run --alg=her --env=Fetchush-v1 --num_timesteps=75000 --seed=$seed; done
